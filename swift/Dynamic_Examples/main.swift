...
InvocationPattern.demoInvocationPattern()
PrototypePattern.demoPrototypePattern()
FlyweightPattern.demoFlyweightPattern()
DecoratorPattern.demoDecoratorPattern()
BundlePattern.demoBundlePattern()
ClassClusterPattern.demoClassClusterPattern()
FacadePattern.demoFacadePattern()
ProxyPattern.demoProxyPattern()
DownloadManager.runDemo()
NoteController.runDemo()
CoreDataPattern.demoCoreDataModelPattern()
ApplicationKitViewsPattern.demoApplicationKitViews()
BindingsAndControllersPattern.demoBindingsAndControllers()
